...
const videos: UGCVideo[] = [
  {
    ...
    name: "Flávia",
    caption: "Fui até a Coreia atrás da glass skin… o segredo tá nesse sérum ✨",
    tag: "Rotina real",
  },
  {
  ...
  },
  {
    ...
    name: "Teste do glow",
    caption: "A pele de dorama é real — o segredo? Ácido hialurônico + colágeno 🎬",
  ...
  },
  {
    ...
    name: "Antes e depois",
    caption: "Antes → depois ⚡ o glow aparecendo com uso diário",
    tag: "Antes de depois",
  },
];
